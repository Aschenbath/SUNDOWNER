...
- latest-validation: Node syntax checks for changed JS modules; `git diff --check`; focused `previewActions.test.js` 103 passing; full Mocha 402 passing with Node 22; headless Chrome DOM/screenshot smoke for My Notes active heading cases.
